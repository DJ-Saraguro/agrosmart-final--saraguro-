...
@Entity
@Table(name = "tbl_productos_base_91")
public class ProductoEntity {
    ...
    public ProductoEntity(String nombreProducto, BigDecimal precioUsd, Integer stockKg, String categoria, String correosNotificacion) {
